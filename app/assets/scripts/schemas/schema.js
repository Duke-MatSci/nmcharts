    ...
    events(){
        const returnSchema = {
            ...
            "transform": [
              ...
              {"bin": {"step": 1}, "field": "logCond", "as": "bin_logCond"},
            ...
            "vconcat": [
              {
                ...
                "selection": {
                  ...
                  "mybrush": {"type": "interval", "encodings": ["x"]}
                },
                "mark": "bar",
                "encoding": {
                  "x": {
              ...
              },
              {
                ...
                "encoding": {
                  ...
                  "opacity": {
                    "condition": {"selection": "selectfillermatls", "value": 0.8},
                    "value": 0.01
                  }
                },
                "layer": [
            ...
            "extras": "This example contains a stacked histogram, and interactive legend, and a linked scatterplot. Click or SHIFT+click in the legend to highlight select filler materials, and click-and-drag a selection brush in the histogram to adjust the scale window of the scatterplot below."
        }
